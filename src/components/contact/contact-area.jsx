                ...
                <div className="tp-contact-info-wrapper">
                  <div className="tp-contact-info-item">
                    ...
                    <div className="tp-contact-info-content">
                      <p data-info="mail">
                        <a href="mailto:contact@shofy.com">contact@KTShop.com</a>
                      </p>
                      <p data-info="phone">
                        <a href="tel:670-413-90-762">+84979569098</a>
                      </p>
                    </div>
                  </div>
                  <div className="tp-contact-info-item">
                    ...
                    <div className="tp-contact-info-content">
                      <p>
                        <a
                          href="https://maps.app.goo.gl/PjJhyEMuvte3ijYo9"
                          target="_blank"
                        >
                          01 Võ Văn Ngân <br /> Thủ Đức, TP.HCM
                        </a>
                      </p>
                    </div>
                  </div>
