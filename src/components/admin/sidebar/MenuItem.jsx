...
export const menuItems = [
  ...
  { icon: Icons.Products, label: "Products", path: "/admin/products" },
  { icon: Icons.Category, label: "Category", path: "/admin/category" },
  { icon: Icons.Orders, label: "Orders", path: "/admin/orders" },
  { icon: Icons.Brand, label: "Brand", path: "/admin/brand" },
